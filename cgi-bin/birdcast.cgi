...
#   @okaydomains=("http://yourdomain.com", "http://www.yourdomain.com");
   ...
   $SCRIPT_NAME="http://koolabunglures.com/cgi-bin/birdcast.cgi";
   $SITE_NAME="KOOLABUNG LURES";
   $SITE_URL="http://koolabunglures.com/";
   $ENDLINE="Koolabung Lures - Fishing for the Future";
   $MAXNUM=5;
   $LOGFILE="reflog.txt";
